...
class long_data_set:
    ...
    def create_data_set(self):
        ...
        measures=np.random.poisson(self.num_measurements,self.num_of_patients)
        ...
        b_cov_matrix.fill(np.sqrt(self.beta_var)*self.b_colin)
        np.fill_diagonal(b_cov_matrix,self.beta_var)
